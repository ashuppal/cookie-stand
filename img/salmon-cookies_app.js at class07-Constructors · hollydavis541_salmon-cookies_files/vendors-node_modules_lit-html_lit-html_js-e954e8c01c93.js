 ...
 */ let d={},e={}},28356(a,b,c){c.d(b,{JG:()=>BooleanAttributePart,K1:()=>EventPart,QG:()=>AttributeCommitter,"_l":()=>AttributePart,m:()=>PropertyCommitter,nt:()=>NodePart,pt:()=>j});let d=c(13695),e=c(66921),f=c(31301),g=c(3122),h=c(89823),i=c(60560);/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 */ class DefaultTemplateProcessor{handleAttributeExpressions(a,b,c,e){let f=b[0];if("."===f){let g=new d.m(a,b.slice(1),c);return g.parts}if("@"===f)return[new d.K1(a,b.slice(1),e.eventContext)];if("?"===f)return[new d.JG(a,b.slice(1),c)];let h=new d.QG(a,b,c);return h.parts}handleTextExpression(a){return new d.nt(a)}};let f=c(89823),g=c(13695),h=c(66921);c(31301);let i=c(60560);/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
