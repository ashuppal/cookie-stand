...
`;let b=a.querySelector("[data-crop-box]");if(!(b instanceof HTMLElement))return;let c=a.querySelector("img");c instanceof HTMLImageElement&&(f.set(this,{box:b,image:c}),c.addEventListener("load",()=>{this.loaded=!0,l(this)}),this.addEventListener("mouseleave",m),this.addEventListener("touchend",m),this.addEventListener("mouseup",m),b.addEventListener("mousedown",j),b.addEventListener("touchstart",j,{passive:!0}),this.addEventListener("keydown",g),this.addEventListener("keydown",h),this.src&&(c.src=this.src))}static get observedAttributes(){return["src"]}get src(){return this.getAttribute("src")}set src(a){a?this.setAttribute("src",a):this.removeAttribute("src")}get loaded(){return this.hasAttribute("loaded")}set loaded(a){a?this.setAttribute("loaded",""):this.removeAttribute("loaded")}attributeChangedCallback(a,b,c){let{image:d}=f.get(this)||{};"src"===a&&(this.loaded=!1,d&&(d.src=c))}}window.customElements.get("image-crop")||(window.ImageCropElement=ImageCropElement,window.customElements.define("image-crop",ImageCropElement)),c(28585);let o,p,q,r,s,t,u,v,w,x=c(76006),y=function(a,b,c,d){let e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(let h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let z=class NavListElement extends HTMLElement{connectedCallback(){this.setShowMoreItemState()}get showMoreDisabled(){return this.showMoreItem.hasAttribute("aria-disabled")}set showMoreDisabled(a){a?this.showMoreItem.setAttribute("aria-disabled","true"):this.showMoreItem.removeAttribute("aria-disabled"),this.showMoreItem.classList.toggle("disabled",a)}set currentPage(a){this.showMoreItem.setAttribute("data-current-page",a.toString())}get currentPage(){return parseInt(this.showMoreItem.getAttribute("data-current-page"))||1}get totalPages(){return parseInt(this.showMoreItem.getAttribute("data-total-pages"))||1}get paginationSrc(){return this.showMoreItem.getAttribute("src")||""}expandItem(a){let b;null===(b=a.nextElementSibling)|| void 0===b||b.removeAttribute("data-hidden"),a.setAttribute("aria-expanded","true")}collapseItem(a){let b;null===(b=a.nextElementSibling)|| void 0===b||b.setAttribute("data-hidden",""),a.setAttribute("aria-expanded","false")}itemIsExpanded(a){return(null==a?void 0:a.tagName)==="A"||(null==a?void 0:a.getAttribute("aria-expanded"))==="true"}handleItemWithSubItemClick(a){let b=a.target;if(!(b instanceof HTMLElement))return;let c=b.closest("button");c&&(this.itemIsExpanded(c)?this.collapseItem(c):this.expandItem(c),a.stopPropagation())}async showMore(a){let b,c;if(a.preventDefault(),this.showMoreDisabled)return;this.showMoreDisabled=!0;let d;try{let e=new URL(this.paginationSrc,window.location.origin);this.currentPage++,e.searchParams.append("page",this.currentPage.toString());let f=await fetch(e);if(!f.ok)return;d=await f.text(),this.currentPage===this.totalPages&&(this.showMoreItem.hidden=!0)}catch(g){this.showMoreDisabled=!1,this.currentPage--;return}let h=this.parseHTML(document,d);null===(b=null==h?void 0:h.querySelector("li > a"))|| void 0===b||b.setAttribute("data-targets","nav-list.focusMarkers"),this.list.insertBefore(h,this.showMoreItem),null===(c=this.focusMarkers.pop())|| void 0===c||c.focus(),this.showMoreDisabled=!1}setShowMoreItemState(){this.showMoreItem&&(this.currentPage<this.totalPages?this.showMoreItem.hidden=!1:this.showMoreItem.hidden=!0)}parseHTML(a,b){let c=a.createElement("template");return c.innerHTML=b,a.importNode(c.content,!0)}};y([x.fA],z.prototype,"list",void 0),y([x.fA],z.prototype,"showMoreItem",void 0),y([x.GO],z.prototype,"focusMarkers",void 0),z=y([x.Ih],z);let A=function(a,b,c,d){let e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(let h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g},B=function(a,b,c,d){if("a"===c&&!d)throw TypeError("Private accessor was defined without a getter");if("function"==typeof b?a!==b||!d:!b.has(a))throw TypeError("Cannot read private member from an object whose class did not declare it");return"m"===c?d:"a"===c?d.call(a):d?d.value:b.get(a)};let C=class SegmentedControlElement extends HTMLElement{constructor(){super(...arguments),o.add(this)}connectedCallback(){B(this,o,"m",p).call(this)}select(a){let b,c;let d=a.currentTarget;for(let e of this.items)e.classList.remove("SegmentedControl-item--selected"),null===(b=e.querySelector("[aria-current]"))|| void 0===b||b.setAttribute("aria-current","false");null===(c=d.closest("li.SegmentedControl-item"))|| void 0===c||c.classList.add("SegmentedControl-item--selected"),d.setAttribute("aria-current","true")}};o=new WeakSet,p=function(){for(let a of this.querySelectorAll(".Button-label"))a.setAttribute("data-content",a.textContent||"")},A([x.GO],C.prototype,"items",void 0),C=A([x.Ih],C),window.customElements.get("segmented-control")||(window.SegmentedControlElement=C,window.customElements.define("segmented-control",C));let D=function(a,b,c,d){let e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(let h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let E=class ToggleSwitchElement extends HTMLElement{get src(){let a=this.getAttribute("src");if(!a)return null;let b=this.ownerDocument.createElement("a");return b.href=a,b.href}get csrf(){let a=this.querySelector("[data-csrf]");return this.getAttribute("csrf")||a instanceof HTMLInputElement&&a.value||null}get csrfField(){return this.getAttribute("csrf-field")||"authenticity_token"}isRemote(){return null!=this.src}toggle(){this.isRemote()?(this.setLoadingState(),this.check()):this.performToggle()}turnOn(){!this.isDisabled()&&(this.switch.setAttribute("aria-checked","true"),this.classList.add("ToggleSwitch--checked"))}turnOff(){!this.isDisabled()&&(this.switch.setAttribute("aria-checked","false"),this.classList.remove("ToggleSwitch--checked"))}isOn(){return"true"===this.switch.getAttribute("aria-checked")}isOff(){return!this.isOn()}isDisabled(){return"true"===this.switch.getAttribute("aria-disabled")}disable(){this.switch.setAttribute("aria-disabled","true")}enable(){this.switch.setAttribute("aria-disabled","false")}performToggle(){this.isOn()?this.turnOff():this.turnOn()}setLoadingState(){this.disable(),this.errorIcon.setAttribute("hidden","hidden"),this.loadingSpinner.removeAttribute("hidden")}setSuccessState(){this.setFinishedState(!1)}setErrorState(){this.setFinishedState(!0)}setFinishedState(a){a&&this.errorIcon.removeAttribute("hidden"),this.loadingSpinner.setAttribute("hidden","hidden"),this.enable()}async check(){let a=new FormData;this.csrf&&a.append(this.csrfField,this.csrf),a.append("value",this.isOn()?"1":"0");try{if(!this.src)throw Error("invalid src");let b=await fetch(this.src,{credentials:"same-origin",method:"POST",headers:{"Requested-With":"XMLHttpRequest"},body:a});b.ok?(this.setSuccessState(),this.performToggle()):this.setErrorState()}catch(c){this.setErrorState()}}};D([x.fA],E.prototype,"switch",void 0),D([x.fA],E.prototype,"loadingSpinner",void 0),D([x.fA],E.prototype,"errorIcon",void 0),D([function(a=0,b={}){return(c,d,e)=>{if(!e||"function"!=typeof e.value)throw Error("debounce can only decorate functions");let f=e.value;e.value=function(a,b=0,{start:c=!1,middle:d=!1,once:e=!1}={}){return function(a,b=0,{start:c=!0,middle:d=!0,once:e=!1}={}){let f=0,g,h=!1;function i(...j){if(h)return;let k=Date.now()-f;f=Date.now(),c?(c=!1,a.apply(this,j),e&&i.cancel()):(d&&k<b||!d)&&(clearTimeout(g),g=setTimeout(()=>{f=Date.now(),a.apply(this,j),e&&i.cancel()},d?b-k:b))}return i.cancel=()=>{clearTimeout(g),h=!0},i}(a,b,{start:c,middle:d,once:e})}(f,a,b),Object.defineProperty(c,d,e)}}(300)],E.prototype,"check",null),E=D([x.Ih],E),window.customElements.get("toggle-switch")||(window.ToggleSwitchElement=E,window.customElements.define("toggle-switch",E));let F=c(48030),G=function(a,b,c,d){if("a"===c&&!d)throw TypeError("Private accessor was defined without a getter");if("function"==typeof b?a!==b||!d:!b.has(a))throw TypeError("Cannot read private member from an object whose class did not declare it");return"m"===c?d:"a"===c?d.call(a):d?d.value:b.get(a)},H=function(a,b,c,d,e){if("m"===d)throw TypeError("Private method is not writable");if("a"===d&&!e)throw TypeError("Private accessor was defined without a setter");if("function"==typeof b?a!==b||!e:!b.has(a))throw TypeError("Cannot write private member to an object whose class did not declare it");return"a"===d?e.call(a,c):e?e.value=c:b.set(a,c),c};let I="tooltip-open",J="sr-only",K=["tooltip-n","tooltip-s","tooltip-e","tooltip-w","tooltip-ne","tooltip-se","tooltip-nw","tooltip-sw"];class ToolTipElement extends HTMLElement{constructor(){super(...arguments),q.add(this),r.set(this,void 0),s.set(this,"center"),t.set(this,"outside-bottom"),u.set(this,!1)}styles(){return`
      :host {
        position: absolute;
        z-index: 1000000;
        padding: .5em .75em;
        ...
        color: let(--color-fg-on-emphasis);
        text-align: center;
        ...
        white-space: pre;
        background: let(--color-neutral-emphasis-plus);
        border-radius: 6px;
        opacity: 0;
        max-width: 250px;
        word-wrap: break-word;
      ...
      :host:before{
        position: absolute;
        z-index: 1000001;
        color: let(--color-neutral-emphasis-plus);
        content: "";
      ...
      :host(.tooltip-sw):before {
        bottom: 100%;
        border-bottom-color: let(--color-neutral-emphasis-plus)
      }
      ...
      :host(.tooltip-nw):before {
        top: 100%;
        border-top-color: let(--color-neutral-emphasis-plus)
      }
      ...
      :host(.tooltip-w):before {
        ...
        left: 100%;
        margin-top: -6px;
        border-left-color: let(--color-neutral-emphasis-plus)
      }
